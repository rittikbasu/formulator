...
const ACTIVE_RIBBON_FILL = "#b91c1c";
const ACTIVE_TEXT_COLOR = "#d4d4d8";

const Badge = ({ ranking, active = false }) => {
  return (
    <div className="relative z-10 md:h-16 md:w-16 h-14 w-14 text-zinc-700 flex items-center justify-center transition-colors duration-300">
      ...
      >
        <path
          className={clsx(
            "badge_ribbon fill-zinc-800/50 transistion-colors duration-500",
            "group-hover:fill-red-700",
            active && "fill-red-700"
          )}
          style={active ? { fill: ACTIVE_RIBBON_FILL } : undefined}
        ...
        <path
          className={clsx(
            "badge_ribbon right fill-zinc-800/50 transistion-colors duration-500",
            "group-hover:fill-red-700",
            active && "fill-red-700"
          )}
          style={active ? { fill: ACTIVE_RIBBON_FILL } : undefined}
      ...
      <span
        className={clsx(
          "absolute inset-0 bottom-4 right-0.5 flex items-center justify-center text-xl font-bold transition-colors duration-500",
